...
def main():
    ...
    parser.add_option('-p', dest='earlystop_p', default=10, type='int', help='Early stopping patience [Default: %default]')
    ...
    checkpoint = tf.keras.callbacks.ModelCheckpoint(out_model_path,
                                                monitor='val_loss',
                                                verbose=1,
                                                save_best_only=True,
                                                mode='min')
